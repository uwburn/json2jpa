...
import it.mgt.util.json2jpa.test.field.entity.FieldEmploymentContract;
...
public class OneToOneMappedByNullRef {

    private static final Logger logger = LoggerFactory.getLogger(OneToOneMappedByNullRef.class);
    ...
    public void test()  {
        ...
        Assert.assertNull(contractWile.getEmployee());
    }
