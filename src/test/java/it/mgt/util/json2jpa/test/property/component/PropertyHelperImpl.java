package it.mgt.util.json2jpa.test.property.component;
...
import it.mgt.util.json2jpa.test.property.entity.PropertyEmploymentContractType;
import it.mgt.util.json2jpa.test.property.entity.PropertyOperation;
