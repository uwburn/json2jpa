...
public class ChangedManyToManyRef {
    ...
    @Transactional
    public void test()  {
        logger.info("Testing changed many-to-many reference property");
        ...
        visitedCountriesJson.add(italy.getId());
        visitedCountriesJson.add(france.getId());
