...
public class Nulls {
    ...
    @Transactional
    public void before() {
        italy = new Country("Italy", "IT", null);
        em.persist(italy);
    }
    ...
    public void test()  {
        ...
        json.putNull("phonePrefix");

        Json2Jpa json2Jpa = json2JpaFactory.build();
        json2Jpa.onChanged("phonePrefix", new ChangedHandler<String>() {
        ...
        Assert.assertFalse("Handler hasn't been invoked", handlerInvoked.isValue());
    }
