...
public class ChangedBasicNested {

    private static final Logger logger = LoggerFactory.getLogger(ChangedBasicNested.class);
    ...
    public void test()  {
        ...
        json2Jpa.onChanged("country/countryCode", new ChangedHandler<String>() {
