...
public class ChangedOneToOneRef {
    ...
    public void test()  {
        ...
        json.put("president", serge.getId());

        Json2Jpa json2Jpa = json2JpaFactory.build();
        json2Jpa.onChanged("president", new ChangedHandler<PersonH>() {

            public void handle(PersonH oldValue, PersonH newValue) {
                handlerInvoked.setValue(true);

                Assert.assertNull(oldValue);
                Assert.assertEquals(serge, newValue);
            }
