...
public class ConstructCollection {
	...
	private Collection<PropertyCompany> newCompanies;
	...
	public void test()  {
        ...
        newCompanies = json2Jpa.construct(List.class, PropertyCompany.class, json);

        em.flush();
        em.clear();

        newCompanies = em.createNamedQuery("PropertyCompany.findAll", PropertyCompany.class)
                .getResultList()
                .stream()
        ...
        for (PropertyCompany c : newCompanies) {
